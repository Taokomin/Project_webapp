...
$GLOBALS['prefix_number'] = '0';

$sql = "SELECT prefix_id FROM tb_nameprefix ORDER BY prefix_id DESC LIMIT 1";
$query = $con->query($sql);
$result = $query->fetch_assoc();


if ($result['prefix_id']) {
    $GLOBALS['prefix_id'] = $result['prefix_id'];
}

function increaseId($prefix_id)
{
    ...
    <div class="container">
        ...
        <form action="insert_name_prefix_db.php" method="post">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="prefix_id" value="<?php echo (increaseId($GLOBALS['prefix_id'])); ?>" readonly>
            </div>
            <div class="mb-3">
            ...
            <a type="button" class="btn btn-danger" href="name_prefix.php">ยกเลิก</a>
        </form>
