...
$ptn_data = $_POST["ptn_data"];

$sql = "SELECT * FROM ptn WHERE fnameptn LIKE '%$ptn_data%'OR lnameptn LIKE '%$ptn_data%' ORDER BY fnameptn ASC ";
...
<body>
    ...
    <div class="container">
        ...
        <div class="col-md-7">
            <form action="searchemp.php" method="POST">
                <div class="input-group mb-3">
                    <input type="text" name="ptn_data" required class="form-control" placeholder="กรอกชื่อผู้ติดต่อที่ต้องการจะค้นหา...">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                &nbsp;&nbsp;
                                <a href="deleteptn.php?delptns=<?php echo $row['idptn']; ?>" class="btn btn-danger">
        ...
        <?php } ?>
        <a href="partner.php" class="btn btn-success">ย้อนกลับ</a>
