...
<body>
  ...
  <div class="container">
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <a type="button" class="btn btn-success" href="insertpartner.php">
      <iconify-icon icon="carbon:document-add" style="color: white;" width="42" height="42"></iconify-icon>
      </iconify-icon>
    </a>
    <br><br>
    <div class="col-md-7">
            <form action="searchptn.php" method="POST">
                <div class="input-group mb-3">
                    <input type="text" name="ptn_data" required class="form-control"
                        placeholder="กรอกชื่อผู้ติดต่อที่ต้องการจะค้นหา...">
    ...
    <table id="mytable" class="table table-bordered table-striped ">
      ...
      <tbody>
        ...
        $sql = $fetchdata->fetchdataptn();
        while ($row = mysqli_fetch_array($sql)) {

        ?>
          <tr>
            <td><?php echo $row['idptn']; ?></td>
            <td><?php echo $row['prefixptn']; ?></td>
            <td><?php echo $row['fnameptn']; ?></td>
            <td><?php echo $row['lnameptn']; ?></td>
            <td><?php echo $row['phoneptn']; ?></td>
            <td><?php echo $row['cnameptn']; ?></td>
            <td>
              <a a href="updateptn.php?idptn=<?php echo $row['idptn']; ?>" class="btn btn-primary">
                <iconify-icon icon="el:file-edit"></iconify-icon>
              </a>
              &nbsp;&nbsp;
              <a href="deleteptn.php?delptn=<?php echo $row['idptn']; ?>" class="btn btn-danger">
