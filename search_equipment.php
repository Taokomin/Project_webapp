...
<body>
    ...
    <div class="container">
        ...
        $equipment_data = $_POST["equipment_data"];
        $sql = "SELECT * FROM tb_equipment WHERE equipment_name LIKE '%$equipment_data%' OR equipment_name LIKE '%$equipment_data%' ORDER BY equipment_name ASC ";
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="update_equipment.php?equipment_number=<?php echo $row['equipment_number']; ?>" class="btn btn-primary"><iconify-icon icon="el:file-edit"></iconify-icon></a>
        ...
        <?php } ?>
        <a href="equipment.php" class="btn btn-success">ย้อนกลับ</a>
