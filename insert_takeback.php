...
$GLOBALS['takeback_number'] = '0';

$sql = "SELECT takeback_id FROM tb_takeback ORDER BY takeback_id DESC LIMIT 1";
$query = $con->query($sql);
$result = $query->fetch_assoc();

if ($result['takeback_id']) {
    $GLOBALS['takeback_id'] = $result['takeback_id'];
}

function increaseId($takeback_id)
{
        ...
        <div class="container">
            ...
            <form id="myForm" method="GET">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="takeback_id" value="<?php echo (increaseId($GLOBALS['takeback_id'])); ?>" readonly>
                </div>
                <div class="mb-3">
                ...
                <script>
                    ...
                    function submitData() {
                        document.getElementById("myForm").action = "insert_takeback_db.php";
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        if (isset($_GET['ref_equipment_id'])) {
                            ...
                            $query = "SELECT * FROM tb_pickup_material WHERE pickup_material_id='$ref_equipment_id' ORDER BY pickup_material_number";
                        ...
                        ?>
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="ref_equipment_name" value="<?= $row['ref_equipment_name']; ?>" readonly>
                                    </div>
                                    <div class="mb-3">
                                        <label for="ref_equipment_quantity" class="form-label">จำนวน</label>
                                        <input type="text" class="form-control" name="ref_equipment_quantity" value="<?= $row['ref_equipment_quantity']; ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="ref_unit_name" class="form-label">หน่วยนับ</label>
                                        <input type="text" class="form-control" name="ref_unit_name" value="<?= $row['ref_unit_name']; ?>" readonly>
                                    </div>
                                    <div class="mb-3">
                                        <label for="ref_equipment_type_number" class="form-label">รหัสประเภทวัสดุและอุปกรณ์</label>
                                        <input type="text" class="form-control" name="ref_equipment_type_number" value="<?= $row['ref_equipment_type_number']; ?>" readonly>
                                    </div>
                                    <div class="mb-3">
                                        <label for="ref_pickup_material_status" class="form-label">สถานะ</label>
                                        <input type="text" class="form-control" name="ref_pickup_material_status" value="<?= $row['ref_pickup_material_status']; ?>" readonly>
                                    </div>
                        <?php
                                }
                            } else {
