...
$md_data = $_POST["md_data"];

$sql = "SELECT * FROM mandedb WHERE mande LIKE '%$md_data%' ORDER BY mande ASC ";
...
<body>
    ...
    <div class="container">
        ...
        <div class="col-md-7">
            <form action="searchemp.php" method="POST">
                <div class="input-group mb-3">
                    <input type="text" name="md_data" required class="form-control"
                        placeholder="กรอกชื่อวัสดุและอุปกรณ์ที่ต้องการจะค้นหา...">
        ...
        <table class="table table-bordered table-striped">
          ...
          ?>
                <tr>
                    <td><?php echo $row["idmande"]; ?></td>
                    <td><?php echo $row["mande"]; ?></td>
                    <td><?php echo $row["mandeqty"]; ?></td>
                    <td><?php echo $row["mandeunit"]; ?></td>
                    <td><?php echo $row["tmqmande"]; ?></td>
                    <td>
                        <a a href="updatemande.php?idmande=<?php echo $row['idmande']; ?>" class="btn btn-primary">
                            <iconify-icon icon="el:file-edit"></iconify-icon>
                        </a>
                        &nbsp;&nbsp;
                        <a href="deletemande.php?delmande=<?php echo $row['idmande']; ?>" class="btn btn-danger">
        ...
        <div class="alert alert-danger">
            <b>ไม่พบข้อมูลวัสดุและอุปกรณ์!!</b>
        </div>
        <?php } ?>
        <a href="mande.php" class="btn btn-success">ย้อนกลับ</a>
