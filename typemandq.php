...
<body>
  ...
  <div class="container">
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <a type="button" class="btn btn-success" href="inserttypemandq.php">
    ...
    <table id="mytable" class="table table-bordered table-striped ">
      ...
      <tbody>
        ...
        $sql = $fetchdata->fetchdatatmq();
        while ($row = mysqli_fetch_array($sql)) {

        ?>
          <tr>
            <td><?php echo $row['idtmq']; ?></td>
            <td><?php echo $row['tmq']; ?></td>
            <td>
              <a a href="updatetmq.php?idtmq=<?php echo $row['idtmq']; ?>" class="btn btn-primary">
                <iconify-icon icon="el:file-edit"></iconify-icon>
              </a>
              &nbsp;&nbsp;
              <a a href="deletetmq.php?deltmq=<?php echo $row['idtmq']; ?>" class="btn btn-danger delete-btn">
