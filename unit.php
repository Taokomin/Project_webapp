...
<body>
  ...
  <div class="container">
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <a type="button" class="btn btn-success" href="insertunit.php">
    ...
    <table id="mytable" class="table table-bordered table-striped ">
      ...
      <tbody>
        ...
        $sql = $fetchdata->fetchdataunit();
        while ($row = mysqli_fetch_array($sql)) {
        ?>
          <tr>
            <td><?php echo $row['idunit']; ?></td>
            <td><?php echo $row['unitt']; ?></td>
            <td>
              <a a href="updateunit.php?idunit=<?php echo $row['idunit']; ?>" class="btn btn-primary">
                <iconify-icon icon="el:file-edit"></iconify-icon>
              </a>
              &nbsp;&nbsp;
              <a a href="deleteunit.php?delunit=<?php echo $row['idunit']; ?>" class="btn btn-danger delete-btn">
