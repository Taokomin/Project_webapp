        ...
        <div class="container">
            ...
            <form action="update_pickup_material_db.php" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="pickup_material_id" value="<?php echo $values['pickup_material_id']; ?>" readonly>
                </div>
                <div class="mb-3">
                    <label for="pickup_material_day" class="form-label">วันที่ส่งมอบ</label>
                    <input type="date" class="form-control" name="pickup_material_day" id="pickup_material_day" value="<?php echo $values['pickup_material_day']; ?>" required>
                ...
                <div class="mb-3">
                    <label for="ref_equipment_name" class="form-label">รหัสสั่งซื้อสินค้าจากลูกค้า</label>
                    <select class="form-select" aria-label="Default select example" name="ref_equipment_name" required>
                ...
                <div class="mb-3">
                    <label for="ref_equipment_name" class="form-label">รหัสประเภทวัสดุและอุปกรณ์</label>
                    <input type="text" class="form-control" name="ref_equipment_name" value="<?php echo $values['ref_equipment_name']; ?>" required>
                </div>
                <div class="mb-3">
                    <label for="ref_employee_number" class="form-label">ชื่อพนักงาน</label>
                    <input type="text" class="form-control" name="ref_employee_number" value="<?php echo ($_SESSION['User']); ?> <?php ?>" required>
                </div>
                <div class="mb-3">
