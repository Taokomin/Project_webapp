...
<body>
    ...
    <div class="container">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <a type="button" class="btn btn-success" href="insertmande.php">
            <iconify-icon icon="carbon:document-add" style="color: white;" width="42" height="42"></iconify-icon>
            </iconify-icon>
        </a>
        <br><br>
        <div class="col-md-7">
            <form action="searchmande.php" method="POST">
        ...
        ?>
                    <tr>
                        ...
                        <td>
                            ...
                            &nbsp;&nbsp;
                            <a a href="deletemande.php?delmande=<?php echo $row['idmande']; ?>"
