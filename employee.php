...
<body>
  ...
  <div class="container">
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <a type="button" class="btn btn-success" href="insertemp.php">
    ...
    <div class="col-md-7">
      <form action="searchemp.php" method="POST">
        <div class="input-group mb-3">
          <input type="text" name="emp_data" required class="form-control" placeholder="กรอกชื่อที่ต้องการจะค้นหา...">
