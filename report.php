    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="d-grid gap-2 col-6 mx-auto">
                <a class="btn btn-primary" type="button">รายงานสรุปยอดขายสินค้าตามช่วงเวลา</a>
                <br><br>
                <a class="btn btn-primary" type="button">รายงานสรุปการสั่งซื้อวัสดุและอุปกรณ์ตามช่วงเวลา</a>
                <br><br>
                <a class="btn btn-primary" type="button">รายงานสรุปยอดวัสดุและอุปกรณ์ตามช่วงเวลา</a>
            </div>
            <br>
            <br>
        </div>
