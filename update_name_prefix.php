<?php
require('condb.php');
$prefix_number = $_GET["prefix_number"];
$sql = "SELECT * FROM tb_nameprefix WHERE prefix_number='$prefix_number'";
...
<body>
    <div class="container">
        ...
        <hr>
        <form action="update_name_prefix_db.php" method="post">
            <input type="hidden" value="<?php echo $values["prefix_number"]; ?>" name="prefix_number">
            <div class="mb-3">
