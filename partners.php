    ...
    <div class="container">
        ...
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        <td><?php echo $values["partners_number"]; ?></td>
                        <td><?php echo $values["partners_id"]; ?></td>
                        <td><?php echo $values["prefix_name"]; ?></td>
                        <td><?php echo $values["partners_fname"]; ?></td>
                        <td><?php echo $values["partners_lname"]; ?></td>
                        <td><?php echo $values["partners_phone"]; ?></td>
                        <td><?php echo $values["partners_company"]; ?></td>
                        <td>
                            <a href="update_partners.php?partners_number=<?php echo $values['partners_number']; ?>" class="btn btn-primary"><iconify-icon icon="el:file-edit"></iconify-icon></a>
                            <a onclick="return confirm('คุณแน่ใจหรือว่าต้องการลบรายการนี้?')" href="delete_partners.php?partners_number=<?php echo $values['partners_number']; ?>" class='btn btn-danger remove'><iconify-icon icon="ant-design:delete-outlined"></iconify-icon></a>
                        </td>
                    </tr>
                <?php
                }
