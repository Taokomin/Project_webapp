...
<head>
  ...
  <title>การจัดการข้อมูลนำหน้าชื่อ</title>
...
<body>
  ...
  <div class="container">
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <a type="button" class="btn btn-success" href="insertprefix.php">
    ...
    <table id="mytable" class="table table-bordered table-striped ">
      ...
      <tbody>
        ...
        ?>
          <tr>
            <td><?php echo $row['idpfix']; ?></td>
            <td><?php echo $row['nameprefix']; ?></td>
            <td>
              <a a href="update.php?idpfix=<?php echo $row['idpfix']; ?>" class="btn btn-primary">
                <iconify-icon icon="el:file-edit"></iconify-icon>
              </a>
              &nbsp;&nbsp;
              <a href="delete.php?del=<?php echo $row['idpfix']; ?>" class="btn btn-danger">
