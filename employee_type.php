...
<body>
    ...
    <div class="container">
        ...
        <br>
        <div class="btn-add">
            <a type="button" class="btn btn-success" href="insert_employee_type.php">
        ...
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                <?php
                include('condb.php');
                $query = "SELECT * FROM tb_employee_type ORDER BY employee_type_number asc" or die("Error:" . mysqli_error());
                $result = mysqli_query($con, $query);
                while ($values = mysqli_fetch_assoc($result)) {
                ?>
                    <tr>
                        <td><?php echo $values["employee_type_number"]; ?></td>
                        <td><?php echo $values["employee_type_id"]; ?></td>
                        <td><?php echo $values["employee_type_name"]; ?></td>
                        <td>
                            <a href="update_employee_type.php?employee_type_number=<?php echo $values['employee_type_number']; ?>" class="btn btn-primary"><iconify-icon icon="el:file-edit"></iconify-icon></a>
                            <a onclick="return confirm('คุณแน่ใจหรือว่าต้องการลบรายการนี้?')" href="delete_employee_type.php?employee_type_number=<?php echo $values['employee_type_number']; ?>" class='btn btn-danger'><iconify-icon icon="ant-design:delete-outlined"></iconify-icon></a>
                        </td>
                    </tr>
                <?php
                }
