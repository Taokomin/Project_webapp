...
$sql = "SELECT * FROM tb_customer_order WHERE customer_order_number = '$customer_order_number'";
...
<head>
    ...
    <title>แก้ไขข้อมูลการสั่งซื้อสินค้าจากลูกค้า</title>
...
<body>
    ...
    <div class="container">
        <h1 class="mt-5">แก้ไขข้อมูลการสั่งซื้อสินค้าจากลูกค้า</h1>
        <hr>
        <form action="update_customer_order_db.php" method="post">
        <input type="hidden" value="<?php echo $values["customer_order_number"]; ?>" name="customer_order_number">
            <div class="mb-3">
                <label for="customer_order_id" class="form-label">รหัสลูกค้า</label>
                <input type="text" class="form-control" name="customer_order_id" value="<?php echo $values['customer_order_id']; ?>" readonly>
            </div>
            <div class="mb-3">
            <label for="customer_order_day" class="form-label">วั่นที่สั่ง</label>
            <input type="date" class="form-control" name="customer_order_day" id="customer_order_day" value="<?php echo $values['customer_order_day']; ?>"required>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="customer_order_detail" value="<?php echo $values['customer_order_detail']; ?>" required>
            </div>
            <div class="mb-3">
                <label for="customer_order_quantity">จำนวน</label>
                <input type="text" class="form-control" name="customer_order_quantity" value="<?php echo $values['customer_order_quantity']; ?>" required>
                <div class="mb-3">
