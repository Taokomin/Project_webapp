...
$checkf = mysqli_query($con, "SELECT * FROM ptn WHERE fnameptn = '" . $fnameptnp . "'");
...
$checkc = mysqli_query($con, "SELECT * FROM ptn WHERE scnameptn = '" . $cnameptn . "'");
...
$result4 = mysqli_num_rows($checkc) or die("เกิดข้อผิดพลาดเกิดขึ้น");
