...
$check = mysqli_query($con, "SELECT * FROM tb_employee WHERE employee_fname = '$employee_fname' OR customer_lname = '$employee_lname'");
...
if ($result > 0) {
    ...
    $sql = "INSERT INTO tb_employee (employee_number, employee_id, ref_nameprefix_number, employee_fname,employee_lname, employee_phone, employee_address, ref_employee_type_number, employee_license) 
