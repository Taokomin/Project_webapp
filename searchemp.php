...
$sql = "SELECT * FROM emp WHERE fnameemp LIKE '%$emp_data%' OR lnameemp LIKE '%$emp_data%' ORDER BY fnameemp ASC ";
        ...
        <div class="col-md-7">
            <form action="searchemp.php" method="POST">
                <div class="input-group mb-3">
                    <input type="text" name="emp_data" required class="form-control"
                        placeholder="กรอกชื่อที่ต้องการจะค้นหา...">
        ...
        <table class="table table-bordered table-striped">
          ...
          ?>
                <tr>
                    ...
                    <td><?php echo $row["prefixemp"]; ?></td>
                    <td><?php echo $row["fnameemp"]; ?></td>
                    <td><?php echo $row["lnameemp"]; ?></td>
                    <td><?php echo $row["phoneemp"]; ?></td>
                    <td><?php echo $row["addressemp"]; ?></td>
                    <td><?php echo $row["tyemp"]; ?></td>
                    <td><?php echo $row["stemp"]; ?></td>
                    <td>
                        <a a href="updateemp.php?idemp=<?php echo $row['idemp']; ?>" class="btn btn-primary">
                            <iconify-icon icon="el:file-edit"></iconify-icon>
                        </a>
                        &nbsp;&nbsp;
                        <a href="deleteemp.php?delemp=<?php echo $row['idemp']; ?>" class="btn btn-danger">
