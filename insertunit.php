...
$sql = "SELECT idunit FROM unitdb ORDER BY idunit DESC LIMIT 1";
$query = $con->query($sql);
$result = $query->fetch_assoc();

if ($result['idunit']) {
  $GLOBALS['idunit'] = $result['idunit'];
}

function increaseId($idunit)
{
  $matchId = preg_replace('/[^0-9]/', '', $idunit);
...
<body>
  ...
  <div class="container">
    ...
    <hr>
    <form action="insertunitdb.php" method="post">
      <div class="mb-3">
        <label for="idunit" class="form-label">รหัสหน่วยนับ</label>
        <input type="text" class="form-control" name="idunit" value="<?php echo (increaseId($GLOBALS['idunit'])); ?>" readonly>
      </div>
      <div class="mb-3">
        <label for="unitt" class="form-label">หน่วยนับ</label>
        <input type="text" class="form-control" name="unitt" required>
      </div>
      &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
